...
*/
// The Main Track output is not hooked up
// We are using an ACS712-LLCTR-10AU on a 12V supply line as the current sensor
// This chip has a 400mV / A sensitivity
// Arduino has 10 bit ADC (0-0xFFFF) for 5V
// voltage (V) = raw / 1024 * 5
// current (A) = voltage / 0.4 = (raw / 1024 * 5) / 0.4
// Now the MotorDriver uses "raw * senseFactor = mA"
// A = 5 / 1024 * 1 / 0.4 * raw = 5 / 409.6 * raw
// mA = raw * 5000 / 409.6
// senseFactor = 12.207...

#define L298N_CUSTOM F("L298N_CUSTOM"), \
   new MotorDriver(7, 6, UNUSED_PIN, UNUSED_PIN, UNUSED_PIN, 12.207, 2000, UNUSED_PIN), \
   new MotorDriver(2, 4, 3, UNUSED_PIN, A1, 12.207, 2000, UNUSED_PIN)
...
//   +-----------------------v
//
#define MOTOR_SHIELD_TYPE L298N_CUSTOM
//
/////////////////////////////////////////////////////////////////////////////////////
//
